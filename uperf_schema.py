...
type_descriptions = (
    ...
    """- accept: Specifies that a connection needs to be accepted from the """
    """remote\n"""
    ...
    """interface. Multiple files are randomly picked from all """
    """transferrable files (see dir below) and tranferred to the """
    """server.\n"""
...
class ProfileFlowOpCommon:
    type: str = field(
        default="error",
        metadata={"name": "type", "description": type_descriptions},
    )
    count: typing.Optional[int] = field(
        default=None,
        metadata={
            "name": "count",
            "description": """The number of times this flowop will be """
            """executed.""",
        },
    )
    rate: typing.Optional[int] = field(
        ...
        metadata={
            "name": "rate",
            "description": """Experimental: This option causes uperf to """
            """execute this flowop at the specified rate for iterations """
            """or duration seconds.""",
        },
...
class ProfileFlowOpConnection(ProfileFlowOpCommon):
    ...
    remotehost: str = field(
        ...
        metadata={
            "name": "remotehost",
            "description": (
                "The remote host server that we need to connect or accept"
                " connection from"
            ),
        },
    )
...
class ProfileFlowOpDataCommon(ProfileFlowOpCommon):
    ...
    size: typing.Annotated[
        ...
        schema.description(
            ...
            """For fixed size messages, the client and all servers used a """
            """sized fixed size for receives and transmits. For """
            """asymmetrical messages, the slaves use the size specified by """
            """the rszize parameter. The master still uses the size """
    ...
    canfail: bool = field(
        ...
        metadata={
            "name": "canfail",
            "description": """Indicates that a failure for this flowop """
            """will not cause uperf to abort. This is espcially useful in """
            """UDP where a packet drop does not constitue a fatal error. """
            """This can be also be used for example, to test a SYN flood """
            """attack (Threads connect() repeatedly ignoring errors).""",
        },
    )
    non_blocking: bool = field(
        ...
        metadata={
            "name": "non_blocking",
            "description": (
                "Use non-blocking IO. The socket/file descriptor is set the"
                " NO_BLOCK flag."
            ),
        },
    )
    poll_timeout: typing.Optional[str] = field(
        ...
        metadata={
            "name": "poll_timeout",
            "description": """If this option is set, the thread will first """
            """poll for specified duration before trying to carry out the """
            """operation. A poll timeout is returned as an error back to """
            """uperf.""",
        },
    )
    conn: typing.Optional[int] = field(
        ...
        metadata={
            "name": "connection id",
            "description": """Every open connection is assigned a """
            """connection name.\n Currently, the name can be any valid """
            """integer, however, uperf could take a string in the future. """
            """conn identifies the connection to use with this flowop. """
            """This connection name is thread private.""",
        },
    )
...
class ProfileFlowOpSendFileCommon(ProfileFlowOpCommon):
    ...
    dir: str = field(
        ...
        metadata={
            "name": "dir",
            "description": """This parameter identifies the directory from """
            """which the files will  be transferred. The directory is """
            """search recursively to generate a list of all readable """
            """files. Example: dir=/space""",
        },
    )
    nfiles: int = field(
        default=1,
        metadata={
            "name": "",
            "description": """This parameter identifies the number of """
            """files that will be transferred with each call to """
            """sendfilev(3EXT). This is used as the 3rd argument to the """
            """sendfilev(3EXT). nfiles is assumed to be 1 for the sendfile """
            """ flowop function. Example: nfiles=10""",
        },
    )
...
class DisconnectFlowOp(ProfileFlowOpCommon):
    ...
    conn: typing.Optional[int] = field(
        ...
        metadata={
            "name": "connection id",
            "description": (
                "If you know the connection ID, you can specify which one to"
                " disconnect."
            ),
        },
    )
...
class ThinkFlowOp(ProfileFlowOpCommon):
    ...
    duration: typing.Optional[
        str
    ] = None  # TODO: Switch to the new time unit once it's added
...
class ProfileTransaction:
    flowops: typing.List[
        typing.Annotated[
            typing.Union[
                typing.Annotated[
                    ConnectFlowOp, annotations.discriminator_value("connect")
                ],
                typing.Annotated[
                    AcceptFlowOp, annotations.discriminator_value("accept")
                ],
                typing.Annotated[
                    DisconnectFlowOp,
                ...
                typing.Annotated[
                    SendFileFlowOp, annotations.discriminator_value("sendfile")
                ],
                typing.Annotated[
                    SendFileVFlowOp,
    ...
    iterations: typing.Optional[int] = field(
        ...
        metadata={
            "name": "iterations",
            "description": (
                "The number of times the contents of the transaction will run."
            ),
        },
    )
    ...
    rate: typing.Optional[int] = field(
        default=None,
        metadata={"name": "rate", "description": "For limiting the rate. "},
    )
...
class ProfileGroup:
    ...
    nthreads: typing.Optional[int] = field(
        ...
        metadata={
            "name": "nthreads",
            "description": """The number of threads to run, with each """
            """thread running a clone of the group""",
        },
    )
    nprocs: typing.Optional[int] = field(
        ...
        metadata={
            "name": "nprocs",
            "description": """The number of processes to run, with each """
            """process running a clone of the group""",
        },
    )
...
class UPerfResults:
    ...
    timeseries_data: typing.Dict[int, typing.Dict[int, UPerfRawData]] = field(
        metadata={
            ...
            "description": """Map of the transaction ID to a map of """
            """timestamp to UPerfRawData.\n"""
            """This result varies by input profile, due to it correlating """
            """to the transactions in the profile. It ignores zero initial """
            """results.""",
        }
    )
